...
- **Agentic deep search** — Powered by Google Gemini 2.5 Flash via the [AI SDK v6](https://sdk.vercel.ai). A planning step generates multiple search queries per round, executed in parallel with scrape-and-summarize before the agent decides to continue or answer.
